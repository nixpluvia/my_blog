    ...
    <header class="top-bar">
        <div class="con flex-ai-end flex-jc-between">
            <h1 class="logo line-height-0">
                <img src="https://nixpluvia.github.io/img1/pf/portfolio/portfolio_logo.png" alt="이호연 포트폴리오">
            </h1>
            <div class="sub-title line-height-0">
                <img src="https://nixpluvia.github.io/img1/pf/portfolio/subtitle.png" alt="last piece portfolio">
            </div>
        </div>
    </header>
    ...
    <div class="wrap">
        ...
        <section class="intro con flex active-on-visible">
            <h2 class="title flex-column line-height-0">
                ...
                <span class="title-paint-line">
                    <img src="https://nixpluvia.github.io/img1/pf/portfolio/title-line.png" alt="line">
                </span>
            </h2>
            <div class="intro-img">
                ...
                <div class="puzzle-line-img img-box">
                    <img src="https://nixpluvia.github.io/img1/pf/portfolio/puzzle-stroke-line.png" alt="">
                </div>
        ...
        <section class="portfolio section-page con active-on-visible">
            ...
            <div class="content-box">
                ...
                <div class="body">
                    <ul class="flex">
                        <li class="item" data-tab-name="box-2" data-tab-body-item-name="2">
                            <div class="frame">
